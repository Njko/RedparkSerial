 ...
 *
 *  Copyright © 2010-2014 Redpark
 *
 *	Revisions:
 *			03mar2010 First Release Docs
 *          01jun2011 modify for libRsc (public api)    
 *          11Feb2014 (ehw) add BTGPS Basestation support
 *          12Mar2014 (ehw)  add BTGPS connection flags
 *
 *
 *  Note:  
 *
...
//
// BTGPS Basestation Support
//
enum
{
    kMaxNameSize = 32,
    
    kFlagConnecting = 0x01,     // only one of these would be on at
    kFlagConnected = 0x02       // any one time
};

//
// discovered, connectable Bluetooth device
//
